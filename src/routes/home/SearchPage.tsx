        ...
        <div>
            ...
            <div className='pt-6 pl-5 '>
                ...
                <div className='w-[340px] flex relative pt-4 overflow-x-auto whitespace-nowrap scrollbar-hide'>
                    ...
                    <div key={index} className='flex pl-3 pr-3 pt-2 pb-2 h-[32px] gap-1 items-center justify-center rounded-full border border-[#B3B3B3] mr-2'>
                        <div className='font-noto text-base text-textgray'>{term}</div>
